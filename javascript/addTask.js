...
let prio = "medium";
let url =
  "https://join-5d8da-default-rtdb.europe-west1.firebasedatabase.app/tasks/.json";
let board = "toDo";
...
function addSubTask() {
  ...
  if (document.getElementById("subtask").value.length > 0 && document.getElementById("subtask").value.replace(/\s+/g, '').length>0) {
...
function loadSubtasks() {
  ...
  for (let i = 0; i < subtasks.length; i++) {
    ...
    document.getElementById("addSubTask").innerHTML += loadSubtaskHTML(
      i,
      subtask
    );
  }
...
function changePrioToUrgent() {
  document.getElementById("urgent").src =
    "./assets/img/activeUrgentPriority.png";
  ...
  document
    ...
    .parentElement.classList.add("urgentPriority");
  document
    .getElementById("medium")
    .parentElement.classList.remove("mediumPriority");
...
function changePrioToMedium() {
  ...
  document.getElementById("medium").src =
    "./assets/img/activeMediumPriority.png";
  document.getElementById("low").src = "./assets/img/lowPriority.png";
  document
    .getElementById("urgent")
    .parentElement.classList.remove("urgentPriority");
  document
    .getElementById("medium")
    .parentElement.classList.add("mediumPriority");
  document.getElementById("low").parentElement.classList.remove("lowPriority");
  prio = "medium";
}
...
function removeAddContactSection() {
  for (let i = 0; i < allContacts.length; i++) {
    if (allContacts[i]["contactSelect"] == true) {
      ...
      document.getElementById("addContactIcon").innerHTML +=
        loadIconForContacts(contact, lastNameInitial, color);
    }
  }
  removeContactFilter();
}
