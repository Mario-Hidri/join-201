...
let subtasks = [];
let prio = "medium";
let url = 'https://join-backend-2c8c7-default-rtdb.europe-west1.firebasedatabase.app/tasks.json';
let board = "toDo";
...
function updateContactList() {
    ...
    let sortedContacts = [...allContacts].sort((a, b) => a.name.localeCompare(b.name));
